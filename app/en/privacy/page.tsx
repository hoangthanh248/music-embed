        ...
        <div className="bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 backdrop-blur-md shadow-2xl space-y-8 text-white/80 leading-relaxed">
           ...
           <div className="space-y-8 text-sm md:text-base">
             ...
             <section>
               ...
               <p>If you have detailed questions regarding this privacy policy, architectural protocols, or our data handling practices, please navigate to our <Link href="/en/contact" className="text-blue-400 hover:underline">Contact page</Link> to connect directly with the system maintainers.</p>
             </section>
           </div>
        </div>
      </div>
