...
export default function PlatformsPage() {
  const platforms = [
    { id: 'spotify', name: 'Spotify', color: 'bg-emerald-400', types: 'track, album, playlist, artist, episode, show' },
    { id: 'apple', name: 'Apple Music', color: 'bg-pink-400', types: 'song, album, playlist, artist, music-video' },
    { id: 'soundcloud', name: 'SoundCloud', color: 'bg-amber-400', types: 'track, set/playlist' },
    { id: 'deezer', name: 'Deezer', color: 'bg-blue-400', types: 'track, album, playlist, artist' },
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
             {platforms.map(platform => (
               <div key={platform.id} className="bg-black/40 border border-white/10 rounded-2xl p-6 hover:bg-white/5 transition-colors group">
                 ...
                 <p className="text-xs text-white/40 uppercase tracking-wider font-mono">Types supported:</p>
